...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm space-y-8 rounded-2xl bg-white p-8 shadow-sm border border-gray-200">
        {/* Header */}
        <div className="space-y-3 text-center">
          ...
          <p className="text-gray-600 text-sm">
            Organize your bookmarks instantly
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          {/* <button
            type="button"
            className="w-full py-3 text-center text-gray-700 font-medium border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
            disabled
          >
        ...
        <div className="text-center text-xs text-gray-500 space-y-2">
          <p>© 2026 Smart Bookmarks. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
