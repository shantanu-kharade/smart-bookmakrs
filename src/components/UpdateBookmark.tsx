                        ...
                        <form action={handleUpdate} className="p-6 space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2
                            ...
                            <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200">
                                ...
                                <button
                                    ...
                                    transition-colors shadow-sm hover:shadow-md cursor-pointer"
                                >
                                    Save Changes
                                </button>
                            </div>
